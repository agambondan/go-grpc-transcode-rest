...
type ArticleAPI struct {
	Title       *string `json:"title,omitempty" gorm:"type:varchar(256);not null;index:,unique,where:deleted_at is null"`
	...
	Views       *int64  `json:"views,omitempty" gorm:"default:0"`
	IsPublished *bool   `json:"is_published,omitempty" gorm:"default:true"`
}
...
type PublicArticle struct {
	...
	Like         *[]Like     `json:"likes,omitempty"`
}
...
func (p *Article) PublicArticle() interface{} {
	...
	//lib.Merge(p.BaseImage, &publicArticle)
